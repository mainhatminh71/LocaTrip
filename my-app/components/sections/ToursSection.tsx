    ...
    <section className="w-full bg-white px-4 py-16 md:px-10 md:py-24">
      <div className="mx-auto w-full max-w-[1200px]">
        <div className="mb-10 max-w-2xl">
          ...
          <h2 className="mt-4 font-display text-[28px] font-bold tracking-[-0.02em] text-[var(--lt-near-black)] md:text-[36px]">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-5">
          {tours.map((tour) => (
            ...
            >
              ...
              <h3 className="font-body line-clamp-2 text-[15px] text-[var(--lt-near-black)]">
                {tour.title}
              </h3>
              <p className="text-[14px] text-[#6b6b6b]">
                Từ <span className="font-semibold text-[var(--lt-near-black)]">{tour.price}</span>{" "}
                / mỗi người
              </p>
            </Link>
          ))}
        ...
        <div className="mt-14 overflow-hidden rounded-[24px] bg-[var(--lt-black)] px-6 py-12 text-center text-white md:px-12">
