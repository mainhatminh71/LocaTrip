...
export const ABOUT = {
  ...
  stats: [
    { value: "N/A", label: "Chuyến đi" },
    { value: "N/A", label: "Địa điểm" },
    { value: "N/A", label: "Bạn đồng hành" },
    { value: "N/A", label: "Du khách" },
    { value: "N/A", label: "Satisfaction" },
    { value: "N/A", label: "Đánh giá" },
  ],
  ...
  team: [
    ...
    { name: "Mai Nhật Minh", role: "Product Engineer" },
  ],
} as const;
